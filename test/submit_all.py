...
def main():
    ...
    config.JobType.inputFiles = [jecera+"BCD"+jecversion+"_DATA_UncertaintySources_AK4PFchs.txt" ,
                                 ...
                                 jecera+jecversion+"_MC_UncertaintySources_AK4PFchs.txt",
...
#    config.Data.outLFNDirBase = '/store/user/adeiorio/SingleTop/trees/2018/Jan/24Jan/prod/'
#    config.Data.outLFNDirBase = '/store/user/adeiorio/SingleTop/trees/2018/Jan/24Jan/decay/'
#    config.Data.outLFNDirBase = '/store/user/adeiorio/SingleTop/trees/2018/Jul/16Jul/'
    config.Data.outLFNDirBase = '/store/user/adeiorio/SingleTop/trees/2019/Mar/09Mar/'
